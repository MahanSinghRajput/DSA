...
public class SkipAChar {
    public static void main(String[] args) {
        skip("","baccdadd");
        System.out.println(skip2("nbaafoqd"));
        System.out.println(skipApple("bbappleiam"));
        System.out.println(skipApp("bbappleiam"));
    }
    ...
    static String skipApp(String up){
        ...
        if(up.startsWith("app") && !up.startsWith("apple")) return skipApp(up.substring(3));
